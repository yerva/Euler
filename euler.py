...
##PS = getPrimes(100000000)
##saveToFile(PS,'hundredMPrimes.txt')
PS = loadFrmFile('tenMPrimes.txt')
ps1= getPrimes(100000)
a=0.0
b=1.0
for n in xrange(1,100000):
    b=b+4
    for x in [4*n*n-2*n+1,4*n*n+1,4*n*n+2*n+1]:
        if x in PS:
            a=a+1
        elif  x>10000000 and isPrime(x,ps1):
            a=a+1
    print [2*n+1,n,a,b,a/b]
    if a/b < 0.1:
        print 2*n+1
        break
